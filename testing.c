    /*******************************************************************************************
    *
    * raylib [text] example - 3d drawing (Modified)
    *
    ...
    ********************************************************************************************/
    ...
    int main(void)
    {
        ...
        while (!WindowShouldClose())        // Detect window close button or ESC key
        {
            ...
            // --- CODE REMOVED HERE (File Drop Logic) ---
            ...
            // NOTE: This logic is perfect for your "painting obstacles" mechanic
            ...
            tbox = MeasureText3D(font, text, fontSize, fontSpacing, lineSpacing);

            quads = 0;                      // Reset quad counter
            time += GetFrameTime();         // Update timer needed by `DrawText3D()`
            //----------------------------------------------------------------------------------
            ...
            BeginDrawing();
                    ...
                    BeginShaderMode(alphaDiscard);
                        ...
                        rlPushMatrix();
                            ...
                            for (int i = 0; i < layers; i++)
                            {
                                ...
                                DrawText3D(font, text, (Vector3){ -tbox.x/2.0f, layerDistance*i, -4.5f }, fontSize, fontSpacing, lineSpacing, true, clr);
                            }
                ...
                //-------------------------------------------------------------------------
                // MODIFIED: Removed instruction to drag and drop files
                DrawText("Type something, see what happens!\n\n"
    ...
    static Vector3 MeasureText3D(Font font, const char* text, float fontSize, float fontSpacing, float lineSpacing)
    {
        ...
        // x(GetFontDefault(),     , 0.8f, 0.1f);font, text, fontSize, fontSpacing, lineSpacing
